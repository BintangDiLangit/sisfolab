                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-blue">
                        <div class="card-header">
                            <h3 class="card-title">Edit Data Instansi Lain</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{ route('user.instansi.update', $user->id) }}" method="POST"
                                ...
                                <a class="btn btn-danger" type="button"
                                    href="{{ route('user.instansi.index') }}">Cancel</a>
